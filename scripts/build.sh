#!/usr/bin/env bash
#
# Manage a docker development environment for the reader 
...
start(){
  ...
  ./scripts/docker/wait-for-it.sh db:3308 --timeout=25 --strict -- echo "Database is up!"
...
set_env_vars(){
  ...
  export POSTGRES_DATABASE="maildigest_development"
